 ...
 */
@EnableBinding(StreamContentRouteApplication.TestTopic.class)
@SpringBootApplication
public class StreamContentRouteApplication {

    public static void main(String[] args) {
        SpringApplication.run(StreamContentRouteApplication.class, args);
    }
